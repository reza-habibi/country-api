        ...
        $(".country-item").click(function (e) {
            $.ajax({
                ...
                $.ajax({
                    ...
                    $("#weather").html(`
                    <img src="http://openweathermap.org/img/wn/${response.weather[0].icon
                        }@2x.png">
                ...
                $('.weamap').css('box-shadow','10px 10px 23px -7px rgba(0, 0, 0, 0.41)')
